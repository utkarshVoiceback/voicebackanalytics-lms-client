...
export default function ModuleManagementModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative w-full max-w-2xl transform overflow-hidden rounded-2xl bg-white dark:bg-slate-900 text-left align-middle shadow-2xl transition-all m-4 border border-slate-200 dark:border-slate-800 flex flex-col max-h-[90vh]">
        {/* Header */}
            ...
            <div className="space-y-3">
              ...
              {modules.map((module, index) => (
                <div
                  ...
                  className={`flex items-center gap-4 p-4 rounded-lg border-2 transition-all cursor-move ${
                    draggedItem === module.courseModuleId
                      ? "border-blue-400 bg-blue-50 dark:bg-blue-500/10 opacity-70"
                ...
                >
                  ...
                  {/* Sequence Number */}
                  <div className="flex-shrink-0 flex items-center justify-center w-10 h-10 rounded-lg bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-500/20 dark:to-purple-500/20 border border-blue-200 dark:border-blue-500/20 text-blue-600 dark:text-blue-400 font-bold text-sm">
                    {index + 1}
                  </div>
        ...
        {!loading && modules.length > 0 && (
          <div className="flex items-center justify-end gap-3 border-t border-slate-200 dark:border-slate-800 px-8 py-4 bg-slate-50 dark:bg-slate-800/50">
            <button
              onClick={onClose}
