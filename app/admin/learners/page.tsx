  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div>
          <h1 className="text-3xl font-bold text-white tracking-tight">Learners</h1>
          <p className="text-slate-400 mt-1">Manage and view all enrolled learners</p>
        </div>
      </div>
      ...
      <div className="mb-6">
        <input
          ...
          className="w-full max-w-md rounded-lg border border-slate-700 bg-slate-800 px-4 py-2.5 text-sm text-white placeholder-slate-500 outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
        />
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-16 bg-slate-900 border border-slate-800 rounded-xl">
          ...
          <h3 className="text-lg font-medium text-slate-300 mb-1">No learners found</h3>
          <p className="text-sm text-slate-500">There are no learners matching your search.</p>
        </div>
      ) : (
