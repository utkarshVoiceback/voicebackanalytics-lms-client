  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex justify-between items-start mb-8">
        <div>
          <h1 className="text-3xl font-bold text-white mb-2">Home Page Banners</h1>
          <p className="text-slate-400">Manage banners displayed on the public home page</p>
        </div>
        <Link
                  ...
                  <tr key={banner.id} className="hover:bg-slate-800/30 transition-colors">
                    <td className="px-6 py-4">
                      {banner.imageUrl ? (
                        ...
                        <div className="w-20 h-12 bg-slate-800 rounded flex items-center justify-center text-slate-500">
                          No image
                        </div>
                      )}
                    </td>
                    ...
                    <td className="px-6 py-4 font-mono text-slate-400">{banner.displayOrder}</td>
                    <td className="px-6 py-4">
                      <button
      ...
      {!loading && banners.length === 0 && (
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-12 text-center">
          ...
          <p className="text-slate-400 mb-6">Create your first banner to get started</p>
          <Link
            href="/admin/home-page/banners/create"
