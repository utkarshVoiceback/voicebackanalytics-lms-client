        ...
        <div key={content.id} className="mb-8">
          ...
          >
            ...
            <div className="flex-1">
              <p className="font-semibold transition-colors text-orange-100 group-hover:text-orange-300">View / Download Presentation</p>
              <p className="text-sm text-slate-400 truncate max-w-sm">{content.title || "Open Document"}</p>
            </div>
          </a>
        </div>
      );
      ...
      return (
        <div key={content.id} className="mb-8">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-sm font-medium text-slate-300">Image · {content.estimatedMinutes} min</span>
          </div>
      ...
      return (
        <div key={content.id} className="mb-8">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-sm font-medium text-slate-300">Content · {content.estimatedMinutes} min</span>
          </div>
          <a
            href={getSecureFileUrl(content.id)}
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-4 rounded-xl border p-4 transition-colors group border-slate-700 bg-slate-800/50 hover:bg-slate-800"
          >
            ...
            <div className="flex-1">
              <p className="font-semibold transition-colors text-slate-200 group-hover:text-white">Open / Download File</p>
              <p className="text-sm text-slate-400 truncate max-w-sm">{content.title || "Content file"}</p>
            </div>
          </a>
        </div>
      );
